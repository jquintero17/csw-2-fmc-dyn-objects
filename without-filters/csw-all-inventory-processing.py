...
def read_and_process_csv(filename):
    ...
    def process_row(row):
        ...
        # If the netmask is empty, use CIDR value or default to /32
...
def convert_to_json(df):
    ...
    for _, row in grouped.iterrows():
        json_entry = {
            "name": sanitize_name(f"csw-fmc-{row['filter_name']}"),  # Add prefix here
            "type": "DynamicObject",
            "objectType": "IP",
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            timestamped_print(f"Retrieved {num_filters} inventory filters.")
        ...
        time.sleep(30)  # Wait 30 seconds before next loop